...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-001.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-004.png}
...
tersebut dan merupakan segitiga siku-siku.
\end{eulercomment}
\begin{eulerprompt}
>plotSegment(A,B,"c")
>plotSegment(B,C,"a")
...
>aspect(1):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-005.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-006.png}
\begin{eulercomment}
...
>plotCircle(circleWithCenter(P,r),"Lingkaran dalam segitiga ABC"):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-007.png}
...
\]
\end{eulerformula}
\eulerimg{1}{images/raffi geometri-009-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/raffi geometri-015-large.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-019.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-021.png}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-022.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-026.png}
\begin{eulerprompt}
>sol &= solve([x^2+y^2=b^2,(x-a)^2+y^2=c^2],[x,y])
\end{eulerprompt}
\begin{euleroutput}
...
\end{eulerprompt}
\eulerimg{19}{images/raffi geometri-030.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/raffi geometri-034-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-035.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/raffi geometri-041-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-042.png}
\begin{eulercomment}
Plot segmen.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-043.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-045.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-047.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/raffi geometri-051-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-054.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-057.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-059.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-064.png}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-066.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-067.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/raffi geometri-070-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/raffi geometri-073-large.png}
\begin{eulercomment}
...
>insimg(30);
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-074.png}
\begin{eulercomment}
Tentu saja,
...
\]
\end{eulerformula}
\eulerimg{1}{images/raffi geometri-081-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-085.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/raffi geometri-088-large.png}
\eulerimg{0}{images/raffi geometri-089-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/raffi geometri-092-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/raffi geometri-100-large.png}
...
\]
\end{eulerformula}
\eulerimg{0}{images/raffi geometri-108-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-110.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/raffi geometri-112-large.png}
\eulerimg{1}{images/raffi geometri-113-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-115.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-118.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-122.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-123.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-124.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-125.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-126.png}
...
>insimg;
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-127.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-128.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-129.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-130.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-131.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-132.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-133.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],add=1,color=12,points=1);
>insimg;
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-134.png}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-135.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-139.png}
...
>povend();
\end{eulerprompt}
\eulerimg{19}{images/raffi geometri-140.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/raffi geometri-141.png}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-142.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-143.png}
...
\]
\end{eulerformula}
\eulerimg{1}{images/raffi geometri-145-large.png}
\begin{eulerprompt}
>h &= perpendicular(A,lineThrough(B,C)) // h melalui A tegak lurus BC
\end{eulerprompt}
\begin{euleroutput}
...
\]
\end{eulerformula}
\eulerimg{0}{images/raffi geometri-150-large.png}
\begin{eulerprompt}
>$computeAngle(A,C,B) // nilai <ACB
\end{eulerprompt}
\begin{eulerformula}
...
>plotPoint(P1); plotPoint(P2):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-154.png}
\begin{eulercomment}
\end{eulercomment}
\begin{eulerprompt}
>c &= circleWithCenter(A,4) // lingkaran dengan pusat A jari-jari 4
...
>insimg;
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-156.png}
\eulersubheading{ Garis Sumbu}
\begin{eulerprompt}
>A=[3,3]; B=[-2,-3];
>c1=circleWithCenter(A,distance(A,B));
...
>plotPoint(A); plotPoint(B); plotSegment(A,B); plotLine(l):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-157.png}
\begin{eulerprompt}
>A &= [a1,a2]; B &= [b1,b2];
>c1 &= circleWithCenter(A,distance(A,B));
>c2 &= circleWithCenter(B,distance(A,B));
...
>plotSegment(A,B,""); plotSegment(B,C,""); plotSegment(C,A,""):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-161.png}
\begin{eulerprompt}
>$areaTriangle(A,B,C)
\end{eulerprompt}
\begin{eulerformula}
...
\]
\end{eulerformula}
\eulerimg{1}{images/raffi geometri-165-large.png}
\begin{eulercomment}
\end{eulercomment}
\begin{eulerprompt}
>LL &= circleThrough(A,B,C); $getCircleEquation(LL,x,y)
...
>plotCircle(LL()); plotPoint(O(),"O"):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-168.png}
\begin{eulerprompt}
>H &= lineIntersection(perpendicular(A,lineThrough(C,B)),...
>  perpendicular(B,lineThrough(A,C))); $H
\end{eulerprompt}
...
>plotPoint(H(),"H"); plotLine(el(),"Garis Euler"):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-171.png}
\begin{eulercomment}
\end{eulercomment}
\begin{eulerprompt}
>M &= (A+B+C)/3; $getLineEquation(el,x,y) with [x=M[1],y=M[2]]
...
>plotPoint(M(),"M"): // titik berat
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-173.png}
\begin{eulerprompt}
>$distance(M,H)/distance(M,O)|radcan
\end{eulerprompt}
\begin{eulerformula}
...
>color(5); plotCircle(LD()):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-178.png}
...
>insimg;
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-179.png}
\begin{eulerprompt}
>$distance(A,B)
\end{eulerprompt}
\begin{eulerformula}
...
\]
\end{eulerformula}
\eulerimg{0}{images/raffi geometri-182-large.png}
\eulerimg{0}{images/raffi geometri-183-large.png}
\begin{eulercomment}
\end{eulercomment}
\begin{eulerprompt}
>wb &= computeAngle(A,B,C); $wb, $(wb/pi*180)()
...
\]
\end{eulerformula}
\eulerimg{1}{images/raffi geometri-186-large.png}
\begin{eulerprompt}
>sb &= spread(b,a,c); $sb
\end{eulerprompt}
\begin{eulerformula}
...
>insimg;
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-193.png}
\begin{eulerprompt}
>&remvalue(a,b,c,r); // hapus nilai-nilai sebelumnya untuk perhitungan baru
>rabc &= rhs(solve(triplespread(spread(b,r,r),spread(a,r,r),spread(c,r,r)),r)[4]); $rabc
\end{eulerprompt}
...
>title="If you see ellipses, please set your window square"):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-197.png}
\begin{eulercomment}
dan grafiknya juga agak sederhana: bagian atas kerucut:
\end{eulercomment}
\begin{eulerprompt}
>plot3d("d1",xmin=-2,xmax=0,ymin=-2,ymax=0):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-198.png}
\begin{eulercomment}
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-199.png}
\begin{eulercomment}
Grafiknya lebih menarik:
\end{eulercomment}
\begin{eulerprompt}
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-200.png}
\begin{eulercomment}
Pembatasan garis (AB) lebih terkenal:
\end{eulercomment}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-201.png}
\eulersubheading{Tiga poin}
\begin{eulercomment}
Contoh:
\end{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-202.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-203.png}
\begin{eulercomment}
...
>plot3d("d3",xmin=-2,xmax=2,ymin=-2,ymax=2):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-204.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-205.png}
\begin{eulercomment}
\end{eulercomment}
\eulersubheading{Empat poin}
\begin{eulercomment}
...
>plot3d("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-206.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-207.png}
\eulersubheading{Contoh 7: Bola Dandelin dengan Povray}
\begin{eulercomment}
\end{eulercomment}
\begin{eulerprompt}
...
>a:=2; color(blue); plotLine(g1(),""), plotLine(g2(),""):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-208.png}
\begin{eulercomment}
Sekarang kita ambil titik umum pada sumbu y.
\end{eulercomment}
\begin{eulerprompt}
...
>insimg;
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-212.png}
\eulersubheading{Latihan}
\begin{eulercomment}
...
>aspect(1):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-213.png}
\begin{eulerprompt}
...
>plotCircle(c,"Lingkaran luar segitiga ABC"):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-214.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-215.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-216.png}
\begin{eulercomment}
...
>aspect(1):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-217.png}
\begin{eulerprompt}
...
>plotPoint(P,"P"):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-218.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-219.png}
\begin{eulercomment}
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-220.png}
\begin{eulercomment}
...
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-221.png}
\begin{eulercomment}
Batasan ke garis PQ
\end{eulercomment}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-222.png}
\begin{eulercomment}
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-223.png}
\begin{eulercomment}
Grafik yang lebih menarik
\end{eulercomment}
\begin{eulerprompt}
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-224.png}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\eulerimg{29}{images/raffi geometri-225.png}
\end{eulernotebook}
\end{document}
