...
>boxplot(M):
\end{eulerprompt}
\eulerimg{29}{images/Stat-001.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-005.png}
\eulerheading{Tabel}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-012.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-013.png}
\begin{eulerformula}
\[
\text{normaldis(x,m,d)}=\int_{-\infty}^x \frac{1}{d\sqrt{2\pi}}e^{-\frac{1}{2 }(\frac{t-m}{d})^2}\ dt.
\]
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-016.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-017.png}
\begin{eulercomment}
...
>statplot(YT,BT1,"b"):
\end{eulerprompt}
\eulerimg{29}{images/Stat-019.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{29}{images/Stat-020.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-021.png}
\begin{eulercomment}
...
>  angle=30°,ccols=CP):
\end{eulerprompt}
\eulerimg{29}{images/Stat-022.png}
\begin{eulercomment}
...
>shrinkwindow():
\end{eulerprompt}
\eulerimg{29}{images/Stat-023.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-029.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-030.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{29}{images/Stat-031.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-032.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-033.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-034.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{29}{images/Stat-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-038.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-039.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-041.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{29}{images/Stat-042.png}
\eulerheading{Tes}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-043.png}
\begin{eulerprompt}
>t=count(R,21);
\end{eulerprompt}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-044.png}
\begin{eulercomment}
Hapus datanya.
\end{eulercomment}
\begin{eulerprompt}
...
>statplot(u,f,"h"):
\end{eulerprompt}
\eulerimg{29}{images/Stat-045.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-046.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-047.png}
\eulerheading{Daftar}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{29}{images/Stat-048.png}
\begin{eulercomment}
...
\begin{eulercomment}
soal Nomor 1 Carilah rata-rata dan standar deviasi beserta plot dari
data berikut\\
X = 2000,3500,4700,1500,2300,3000
\end{eulercomment}
\begin{eulerprompt}
>X=[2000,3500,4700,1500,2300,3000]; ...
>mean(X), dev(X),
...
\end{eulerprompt}
\eulerimg{19}{images/Stat-049.png}
\begin{eulercomment}
Nomor 2\\
...
\end{eulercomment}
\begin{eulerprompt}
>X=[65,85,48,80,95,98,82,94,76,88,88,94]
\end{eulerprompt}
\begin{euleroutput}
  [65,  85,  48,  80,  95,  98,  82,  94,  76,  88,  88,  94]
\end{euleroutput}
\begin{eulerprompt}
>mean(X)
\end{eulerprompt}
