...
\begin{eulercomment}
Nama : Raffi Dinan Cahya Purnama \\
NIM  : 22305141021\\
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-001.png}
...
>plot3d("x^2+y^2"):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-002.png}
\begin{eulerprompt}
>plot3d("x^2+5*y^2"):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-003.png}
\begin{eulerprompt}
>plot3d("sqrt(x^2+y^2)"):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-004.png}
\begin{eulerprompt}
>plot3d("log(x*y)"):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-005.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-008.png}
\begin{eulercomment}
...
\begin{euleroutput}
  ...
  Error in:
  ... angle=-20°,height=20°,   center=[0.4,0,0],zoom=5): ...
                                                       ^
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-009.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-010.png}
\begin{eulerprompt}
>function f(r) := exp(-r/2)*cos(r); ...
>plot3d("f(x^2+y^2)",>polar,scale=[1,1,0.4],r=2pi,frame=3,zoom=4):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-012.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-013.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-014.png}
\begin{eulerprompt}
>plot3d("exp(x*y)",angle=100°,>contour,color=green):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-015.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-016.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-017.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-020.png}
\begin{eulerprompt}
>function f(x)
\end{eulerprompt}
\begin{eulerudf}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-021.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-022.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-023.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-027.png}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-028.png}
\begin{eulerprompt}
>plot3d("x^2+y^2+4*x*z+z^3",>implicit,r=2,zoom=2.5):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-029.png}
...
>scale=1.4,height=50°):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-030.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-031.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-032.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-033.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-034.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-035.png}
\begin{eulerprompt}
>t=linspace(0,4pi,1000); plot3d(cos(t),sin(t),t/2pi,>wire, ...
>linewidth=3,wirecolor=blue):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-036.png}
\begin{eulerprompt}
>X=cumsum(normal(3,100)); ...
> plot3d(X[1],X[2],X[3],>anaglyph,>wire):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-038.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-039.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-041.png}
\eulerheading{Plot Statistik batang 3d}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-042.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-043.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-044.png}
\begin{eulerprompt}
>Z=intrandom(5,100,6); v=zeros(5,6); ...
>loop 1 to 5; v[#]=getmultiplicities(1:6,Z[#]); end; ...
>columnsplot3d(v',scols=1:5,ccols=[1:5]):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-045.png}
...
>level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-046.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-051.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-052.png}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-053.png}
\begin{eulercomment}
...
>myplot(x,y,z):
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-054.png}
...
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-055.png}
...
\end{eulerprompt}
\eulerimg{20}{images/EMT4Plot3DRaffi-056.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{20}{images/EMT4Plot3DRaffi-057.png}
\begin{eulercomment}
...
>  <fscale,zoom=3.8);
\end{eulerprompt}
\eulerimg{20}{images/EMT4Plot3DRaffi-058.png}
...
\end{eulerprompt}
\eulerimg{20}{images/EMT4Plot3DRaffi-059.png}
\begin{eulercomment}
...
>  w=500,h=300);
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot3DRaffi-060.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{20}{images/EMT4Plot3DRaffi-061.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Plot3DRaffi-062.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{20}{images/EMT4Plot3DRaffi-063.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{20}{images/EMT4Plot3DRaffi-064.png}
...
>povend;
\end{eulerprompt}
\eulerimg{20}{images/EMT4Plot3DRaffi-065.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{20}{images/EMT4Plot3DRaffi-066.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{20}{images/EMT4Plot3DRaffi-067.png}
...
>povend();
\end{eulerprompt}
\eulerimg{20}{images/EMT4Plot3DRaffi-068.png}
...
>povend();
\end{eulerprompt}
\eulerimg{20}{images/EMT4Plot3DRaffi-069.png}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-070.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-071.png}
...
>povend(h=320,w=480);
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot3DRaffi-072.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{20}{images/EMT4Plot3DRaffi-073.png}
...
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-074.png}
\begin{eulerprompt}
>P &= [0,u]
\end{eulerprompt}
\begin{euleroutput}
...
>insimg;
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-075.png}
\begin{eulerprompt}
>load povray;
>defaultpovray="D:\(\backslash\)poray\(\backslash\)bin\(\backslash\)pvengine.exe"
\end{eulerprompt}
...
>povend();
\end{eulerprompt}
\eulerimg{20}{images/EMT4Plot3DRaffi-076.png}
...
>povend();
\end{eulerprompt}
\eulerimg{20}{images/EMT4Plot3DRaffi-077.png}
\begin{eulerprompt}
...
>pov3d(x,y,z,zoom=4);
\end{eulerprompt}
\eulerimg{20}{images/EMT4Plot3DRaffi-078.png}
\begin{eulerprompt}
>X=phix(x,y,z); Y=phiy(x,y,z); Z=phiz(x,y,z);
>pov3d(X,Y,Z,zoom=3.8);
\end{eulerprompt}
\eulerimg{20}{images/EMT4Plot3DRaffi-079.png}
\begin{eulerprompt}
>plot3d(X,Y,-Z,>hue,zoom=3.6):
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-080.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-081.png}
\begin{eulerprompt}
...
>povend();
\end{eulerprompt}
\eulerimg{20}{images/EMT4Plot3DRaffi-082.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-083.png}
\begin{eulerprompt}
>plot3d(expr,implicit=1,r=1.5,<frame,zoom=5,height=40°,n=20,>anaglyph):
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-084.png}
\begin{eulerprompt}
...
>figure(0):
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-085.png}
...
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-086.png}
\begin{eulerprompt}
>plot3d(x,y,z,frame=0,scale=1.5,hue=1,light=[1,0,-1],anaglyph=1,zoom=3.2):
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-087.png}
\begin{eulerprompt}
...
>zoom=3,anaglyph=1):
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-088.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-089.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-090.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-091.png}
\begin{eulerprompt}
>pov3d(gx(s,t),gy(s,t),gz(s,t),zoom=5,axis=0, ...
>look=povlook(gray,>phong));
\end{eulerprompt}
\eulerimg{20}{images/EMT4Plot3DRaffi-092.png}
\begin{eulerprompt}
>pov3d(gx(s,t),gy(s,t),gz(s,t),zoom=5,axis=0, ...
>look=povlook(gray,),>anaglyph);
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot3DRaffi-093.png}
...
>povend();
\end{eulerprompt}
\eulerimg{20}{images/EMT4Plot3DRaffi-094.png}
\eulersubheading{Bola}
\begin{eulerprompt}
> plot3d("x^2+y^2+z^2-16",r=5,implicit=3):
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-095.png}
\eulersubheading{Elipsoida}
\begin{eulerprompt}
>plot3d("x^2*(1/4)+y^2*(1/9)+z^2*(1/4)-1",r=3,implicit=3):
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-096.png}
\eulersubheading{Hiperboloida}
\begin{eulerprompt}
>plot3d("4x^2+9y^2-z^2-36",r=8,implicit=3):
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-097.png}
\begin{eulerprompt}
>plot3d("16z^2-4y^2-9x^2-144",r=30,implicit=3,>user):
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-098.png}
\eulersubheading{Paraboloida}
\begin{eulerprompt}
>plot3d("1-x^2",xmin=0,xmax=1,rotate=2):
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-099.png}
\begin{eulerprompt}
>plot3d("x^2*(1/25)+y^2*(1/16)-z",r=20,implicit=3):
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-100.png}
\begin{eulerprompt}
>plot3d("x^2*(1/9)-y^2*(1/16)-z*(1/2)",r=15,implicit=2):
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-101.png}
\eulersubheading{Kerucut}
\begin{eulerprompt}
>plot3d("1-x",xmin=0,xmax=1,rotate=2):
\end{eulerprompt}
\eulerimg{29}{images/EMT4Plot3DRaffi-102.png}
\begin{eulerprompt}
> 
\end{eulerprompt}
\end{eulernotebook}
